...
class AutoClone(object):
    ...
    def get_code(contest_id: str, submission_id: int) -> str:
        ...
        return BeautifulSoup(requests.get(submission_url).content, "html.parser").pre.string
    ...
    def write_code(code, contest_id, problem_id, language) -> None:
        ...
        path = f"submissions/{contest_id}/{problem_id}.{extension}"
    ...
    def get_extension(language: str) -> str:
        ...
        if extension is None:
            raise Exception(f"Extension for {language} did not found. Please contact @kuriyan1204 via GitHub")
        return extension
